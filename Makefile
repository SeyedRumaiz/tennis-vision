.PHONY: help venv install run infer check clean clean-stubs clean-all
...
install: venv
	...
	. .venv/bin/activate && $(PIP) install ultralytics opencv-python pandas numpy torch torchvision
